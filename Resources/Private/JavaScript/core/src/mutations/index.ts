import CREATE_ASSET_COLLECTION from './createAssetCollection';
import CREATE_TAG from './createTag';
import DELETE_ASSET from './deleteAsset';
...
import UNTAG_ASSET from './untagAsset';
